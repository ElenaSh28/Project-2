...
- `data/raw/` - исходные необработанные данные
  - `Pub1657_web_en_dataset.csv` - [описание]
  
- `data/alma/` - данные ALMA-моделей
  - `alma_flores_base.csv` - [описание]
  - `alma_test.csv` - тестовые данные
  - `alma_test_base.csv` - базовые тесты

- `data/opus/` - данные OPUS-корпусов
  - `opus_wmt16.csv` - основной датасет
  - `opus_test.csv` - тестовые данные
  - `opus_wmt16_alma_base.csv` - комбинированные данные
